...
parser.add_argument('--pretrain_train_split_ratio', type=float, default=0.8, help='train split ratio for pretrain ETT loaders')
parser.add_argument('--pretrain_eval_split_ratio', type=float, default=0.2, help='evaluation split ratio for pretrain ETT loaders')
...
if min(args.seq_len, args.label_len, args.pred_len) <= 0:
